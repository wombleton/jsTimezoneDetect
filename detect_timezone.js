/*jslint indent: 2, nomen: false, white: false, plusplus: false, regexp: false */
/*global jQuery: false */
 ...
 */
(function($) {var HEMISPHERE_SOUTH = 'SOUTH',
  ...
  TimeZone.prototype.ambiguity_check = function() {
    var i,
        local_ambiguity_list = olson.ambiguity_list[this.olson_tz],
        length,
        tz;
    ...
    length = local_ambiguity_list.length;

    for (i = 0; i < length; i++) {
      tz = local_ambiguity_list[i];
  ...
  function determine_timezone() {
    ...
    return {
      ...
      'key' : tz_key,
      name: olson.timezones[tz_key].olson_tz
    };
  }
